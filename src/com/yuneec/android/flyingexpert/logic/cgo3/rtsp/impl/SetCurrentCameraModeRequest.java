 ...
 ********************************************************************
 */
public class SetCurrentCameraModeRequest extends CGO3_RtspRequest {
	...
	public SetCurrentCameraModeRequest(int mode) {
		this.mode = mode;
		switch (mode) {
		case 2:
			currentMode = "photo";
	...
	public String getUrl() {
		return BASE_URL+CGO3_RTSPcommand.URL_SET_CAMERA_MODE.cmd()+"&mode="+currentMode;
	}
