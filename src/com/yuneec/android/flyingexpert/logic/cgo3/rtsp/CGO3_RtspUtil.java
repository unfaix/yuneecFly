...
public class CGO3_RtspUtil {
	...
	public static void sendRequest(Context context, CGO3_RtspRequest request,
		...
		CGO3_RtspRequestThread requestThread = new CGO3_RtspRequestThread(runnable);
	...
	public static class RequestRunnable implements Runnable {
		private CGO3_RtspRequest request;
		private Message message;
		private Context context;
		private boolean flag = true;

		public RequestRunnable(Context context, CGO3_RtspRequest request,
				Message message) {
