 ...
 ********************************************************************
 */
public class GetPhotoFormatRequest extends CGO3_RtspRequest {
	...
	public void parseResponse() throws JSONException {
		...
		if (resultCode == 0) {
			if (rootObject.has("photo_format")) {
				format = rootObject.getString("photo_format");
			}
		} else {
	...
	public String getUrl() {
		return BASE_URL+CGO3_RTSPcommand.URL_GET_PHOTO_FORMAT.cmd();
    }
